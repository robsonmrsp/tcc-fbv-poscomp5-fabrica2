...
public class Lote {
	...
	private String dimensaoEsqueda;
	...
	public Lote(String numero, String quadra, String confFrente,
			...
			String dimensaoEsqueda, double valorM2) {
		super();
		this.numero = numero;
		this.quadra = quadra;
		...
		this.dimensaoEsqueda = dimensaoEsqueda;
	...
	public String getDimensaoEsqueda() {
		return dimensaoEsqueda;
	}

	public void setDimensaoEsqueda(String dimensaoEsqueda) {
		this.dimensaoEsqueda = dimensaoEsqueda;
	}
